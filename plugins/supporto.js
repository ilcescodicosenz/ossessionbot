...
let handler = async (m, {
  ...
  const ownerNumber = "393508364499";
...
⟆ 𝑶𝑺𝑺𝑬𝑺𝑺𝑰𝑶𝑵𝑩𝑶𝑻 ⟇ ✦ ════════════════════`.trim();
  ...
  const buttons = [{
    buttonId: 'canale_tutorial',
    buttonText: {
      displayText: '📺 Mostra Canale'
    },
    type: 1
  }, {
    buttonId: 'scrivi_owner',
    buttonText: {
      displayText: '✉️ Scrivi all\'Owner'
    },
    type: 1
  }, {
    buttonId: 'gruppo_supporto',
    buttonText: {
      displayText: '👥 Gruppo Supporto'
    },
    type: 1
  }];
