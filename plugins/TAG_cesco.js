...
handler.all = async function (m) {
  ...
  if (/^@+393755853799|@393755853799/i.test(m.text)) {
    ...
    const whatsappGroupLink = "https://chat.whatsapp.com/FTHuRX16IVXDv0WQvDNxqw"; // 🔗 Sostituisci con il link reale del tuo gruppo
    ...
    conn.reply(
      m.chat, 
      `🔗 *Instagram:* [f.cesco_](https://instagram.com/f.cesco_)\n\n👥 *WhatsApp Group:* [Join Here](${whatsappGroupLink})\n\n📩 *Se volete il bot, fate .supporto*`, 
      prova, 
      m
    );
  }
