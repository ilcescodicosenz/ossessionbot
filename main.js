...
mobile: MethodMobile, 
browser: opcion == '1' ? ['ossessionbot 1.𝟎', 'Safari', '1.0.0'] : methodCodeQR ? ['ossessionbot', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `ossessionbot 𝐨𝐧𝐥𝐢𝐧𝐞 𝐝𝐚 ${uptime} `
